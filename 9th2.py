    ...
    **Data Type:** Structured (CSV/Table)
    ...
    if st.button("🔁 Apply Anonymization"):
        ...
        if method != "Compare All 4":
            ...
            # Risk Analysis
            st.markdown("### ⚖️ Step 4: Re-identification Risk Analysis")
        ...
        # ----------------- Compare All Techniques -----------------
            ...
            ⚖️ However, if **data accuracy** is more important (e.g., analysis or ML training), use **t-Closeness** or combine **k-Anonymity + Differential Privacy**.
            """)
